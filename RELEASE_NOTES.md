...
1. Release 자산의 `dhxk-0.3.0-skala-universal-adhoc.zip`과 `.sha256` 파일을 받는다.
...
상세 절차는 [사용자 매뉴얼](https://github.com/jinsu1011/dhxk/blob/v0.3.0/USER_MANUAL.md)을 따른다. 최초 등록 전에 [개인정보 처리 안내](https://github.com/jinsu1011/dhxk/blob/v0.3.0/PRIVACY.md)를 확인한다.
